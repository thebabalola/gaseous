...
/**
 * @title SimpleAccount
 * @notice Minimal ERC-4337 smart contract account
 * @dev Based on the reference implementation from @account-abstraction/contracts
 * 
 * This is the user's smart wallet that:
 * - Receives and executes UserOperations
 * - Is owned by an EOA (or another smart contract)
